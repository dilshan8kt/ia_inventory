...
$( ".addnew" ).append( "<button name='add-new-department' data-backdrop='static' data-toggle='modal' data-target='#add' id='add-new-department' class='btn btn-primary'>Add New Department</button>");
