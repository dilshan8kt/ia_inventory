            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="{{ route('category') }}" data-parsley-validate="true">
                    ...
                    <div class="form-group row m-b-15">
                        ...
                        <div class="col-md-8 col-sm-8">
                            <input class="form-control {{ $errors->has('name') ? ' parsley-error' : '' }}" value="{{ old('name') }}" type="text" id="name" name="name" placeholder="Item Category Name" data-parsley-required="true" />
