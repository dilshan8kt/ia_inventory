<div class="modal fade" id="viewSubLocation" tabindex="-1" aria-hidden="true">
                ...
                <form class="form-horizontal">
                    <div class="form-group row m-b-15">
                        ...
                        <div class="col-md-8 col-sm-8">
                            <input class="form-control" type="text" id="location_name" name="location_name" readonly/>
                        </div>
                    </div>
                    <div class="form-group row m-b-15">
                    ...
                    <div class="form-group row m-b-15">
                        ...
                        <div class="col-md-8 col-sm-8">
                            <input class="form-control" type="text" id="telephone_no" name="telephone_no" readonly/>
                        </div>
                    </div>
